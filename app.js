...
const translations = {
  ...
  en: {
    ...
    'contact.title':'LET’S TALK','contact.kicker':'CONTACT','contact.hero':'Let’s bring your next <span>project</span> to life.','contact.lead':'Tell us about your ideas, goals or challenges. We will review your message and get back to you as quickly as possible.','contact.b1.title':'Fast response','contact.b1.copy':'Usually within 24 hours.','contact.b2.title':'Personalised support','contact.b2.copy':'Solutions tailored to your business.','contact.b3.title':'Confidentiality','contact.b3.copy':'Your data is only used to respond to your enquiry.','contact.formHeading':'Talk to us','contact.direct':'DIRECT CONTACT','contact.directCopy':'Other ways to get in touch.','contact.emailCopy':'Reply within 24h','contact.phone':'Phone','contact.locationTitle':'Location','contact.location':'Algarve, Portugal','contact.locationCopy':'We work with clients throughout Portugal.','contact.hours':'Mon - Fri: 09:00 - 18:00','contact.social':'INSTAGRAM','contact.t1.title':'Personalised strategy','contact.t1.copy':'Every business has its own path.','contact.t2.title':'Measurable results','contact.t2.copy':'Strategy with focus.','contact.t3.title':'Close support','contact.t3.copy':'We grow with you.','contact.t4.title':'Transparency','contact.t4.copy':'Clarity at every stage.','footer.rights':'All rights reserved.','footer.privacy':'Privacy & Cookies','footer.terms':'Terms of Use','a11y.values':'AVYENA values'
  }
};
let lang = 'pt';
try {
