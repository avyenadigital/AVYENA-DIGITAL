...
const translations = {
  pt: {
    ...
    'services.growth.title':'Estratégia & Crescimento','services.growth.copy':'Analisamos, planeamos e implementamos ações que geram crescimento sustentável e previsível.',
    ...
    'promise.kicker':'O QUE PODES ESPERAR DA AVYENA','promise.1.title':'Estratégia adaptada ao teu negócio','promise.1.copy':'Nada de soluções genéricas. Cada plano é feito à medida dos teus objetivos e realidade.','promise.2.title':'Comunicação próxima e transparente','promise.2.copy':'Estamos sempre disponíveis, explicamos tudo de forma simples e caminhamos contigo.','promise.3.title':'Soluções práticas, sem complicações','promise.3.copy':'Focamos no que realmente importa e traz retorno real para o teu negócio.','promise.4.title':'Acompanhamento contínuo','promise.4.copy':'Monitorizamos resultados, otimizamos e evoluímos contigo a cada passo.',
    ...
    'cta.title':'Pronto para levar o seu negócio ao próximo nível?','cta.copy':'Fale connosco e descubra como podemos criar impacto na sua marca.',
  ...
  en: {
    ...
    'services.digital.title':'Digital Solutions & Experience','services.digital.copy':'Digital menus, QR codes, bookings, orders and other solutions that make the customer experience simpler and more modern.',
    ...
    'services.growth.title':'Strategy & Growth','services.growth.copy':'We analyse, plan and implement actions designed to create sustainable, predictable growth.',
    ...
    'cta.title':'Ready to take your business to the next level?','cta.copy':'Talk to us and discover how we can create impact for your brand.',
...
const applyLang = () => {
  ...
  langBtn.querySelector('.flag').textContent = lang === 'pt' ? '🇬🇧' : '🇵🇹';
